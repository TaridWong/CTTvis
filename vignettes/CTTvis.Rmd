...
For the `point_biserial_plot` function, you could adjust your point-biserial correlation (pBis) threshold as well. For example, ff you want the pBis threshold to be .3, you could configure the `pBis_threshold` as follows:
